     ...
     didUpdateLocations:(NSArray<CLLocation *> *)locations
{
    for (CLLocation *loc in locations) {
        // Could also use loc.description:
        // “<<latitude>, <longitude>> +/- <accuracy>m (speed <speed> kph /
        // heading <heading>) @ <date-time>”,
        ...
        CLLocationDirection heading = loc.course;
        ...
        [self logLineToDataFile:
          [NSString stringWithFormat:@"%f,%f,%f,%f,%f,%f,%f,%f\n",
            time, coord.latitude, coord.longitude, altitude, accuracy,
